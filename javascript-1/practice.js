...
let doubled = myNumbers.map( elem => {
	return elem * 2;
})
...
// // Code Here
let filtered = myNumbers.filter((elem) => {
	return elem > 100
})
//////////////////PROBLEM 16////////////////////
...
// Code Here
let total = myNumbers.reduce((curr, acc) => {
	return curr + acc;
}, 0)
//////////////////PROBLEM 17////////////////////
...
// // const forTheLoveOfGeorge = notGeorge.splice(0, 6, "George", "George", "George", "George", "George", "George")
...
const totallyAwesome = people.reduce((acc, curr, i, arr) => {
